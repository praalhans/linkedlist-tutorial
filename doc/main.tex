...
We follow the general workflow as depicted in Figure~\ref{fig:workflow}. The workflow starts with a formalisation of the informal documentation of the Java code in the Java Modeling Language \cite{LeavensBR99}. %supported by the KeY theorem prover.
